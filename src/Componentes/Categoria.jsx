...
export default function Categoria({imagen, titulo, resultado, colorTitulo, colorBackgound}) {
    return(
        <div className="contenedor-categorias" style={{backgroundColor:colorBackgound}}>
